...
export default function CareerFormStep5({
  ...
  const [expandSection1, setExpandSection1] = useState<boolean>(true);
  const [expandSection2, setExpandSection2] = useState<boolean>(false);
  const [expandSection3, setExpandSection3] = useState<boolean>(false);
  const [expandSection4, setExpandSection4] = useState<boolean>(false);
        ...
        <div className={`layered-card-middle`}>
          <div className={styles.sectionHeader}>
            <div
              ...
              onClick={() => setExpandSection1(!expandSection1)}
            >
              <i
                className={
                  expandSection1
              ...
              <div>
                ...
                <div className={styles.fieldGrid}>
                  ...
                  <div>
                    ...
                    <p className={styles.fieldValue}>{formData.city || "—"}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {formData.teamAccess && formData.teamAccess.length > 0 ? (
                    <div className={styles.teamAccessContainer}>
                      {formData.teamAccess.map((member: any, index: number) => (
                        <div
                          key={member.email || index}
                          className={styles.teamAccessItem}
                        >
                          <img
      ...
      <div className={styles.sectionCard}>
        <div className={`layered-card-middle`}>
          <div className={styles.sectionHeader}>
            <div
              className={styles.sectionHeaderLeft}
              onClick={() => setExpandSection2(!expandSection2)}
            >
              <i
                className={
                  expandSection2
          ...
          {expandSection2 && (
            <div className={styles.expandedContent}>
              {/* CV Screening */}
              <div className={styles.fieldSection}>
                <p className={styles.fieldLabel}>CV Screening</p>
              ...
              {formData.cvSecretPrompt && (
                <div className={styles.fieldSection}>
                  ...
                  <ul className={styles.secretPromptList}>
                    {formData.cvSecretPrompt
                      .split("\n")
      ...
      <div className={styles.sectionCard}>
        <div className={`layered-card-middle`}>
          <div className={styles.sectionHeader}>
            <div
              className={styles.sectionHeaderLeft}
              onClick={() => setExpandSection3(!expandSection3)}
            >
              <i
                className={
                  expandSection3
          ...
          {expandSection3 && (
            <div className={styles.expandedContent}>
              ...
              <div className={styles.fieldSection}>
                <p className={styles.fieldLabel}>AI Interview Screening</p>
                <p className={styles.videoValue}>
                  Automatically endorse candidates who are{" "}
                  <span className={styles.screeningBadge}>
                    {formData.screeningSetting || "Good Fit"}
              ...
              <div className={styles.videoRequirement}>
                <p className={styles.videoLabel}>Require Video on Interview</p>
                <p className={styles.videoValue}>
              ...
              <div>
                <div className={styles.questionsSectionHeader}>
                  <p className={styles.questionsTitle}>Interview Questions</p>
                  {getTotalQuestions() > 0 && (
                    <span className={styles.questionsCount}>
                      {getTotalQuestions()}
                    </span>
                ...
                {formData.questions?.map((category: any, catIndex: number) => {
                  if (category.questions?.length > 0) {
                    return (
                      ...
                      >
                        ...
                        >
                          {category.questions.map((q: any, index: number) => (
                            <li
                              key={q.id || index}
      ...
      <div className={styles.sectionCard}>
        <div className={`layered-card-middle`}>
          <div className={styles.sectionHeader}>
            <div
              className={styles.sectionHeaderLeft}
              onClick={() => setExpandSection4(!expandSection4)}
            >
              <i
                className={
                  expandSection4
              ...
              {expandSection4 && (
                <span className={styles.pipelineCount}>4</span>
              )}
            </div>
            <button
              onClick={(e) => {
              ...
              <div className={styles.pipelineGrid}>
                ...
                <div className={styles.pipelineStage}>
                  <div className={styles.stageHeader}>
                    <i className={`la la-user-check ${styles.stageIcon}`}></i>
                    <p className={styles.stageName}>CV Screening</p>
                  </div>
                  <div className={styles.substagesSection}>
                    <p className={styles.substagesLabel}>Substages</p>
                    <div className={styles.substagesList}>
                      <p className={styles.substageItem}>Waiting Submission</p>
                      <p className={styles.substageItem}>For Review</p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.pipelineStage}>
                  <div className={styles.stageHeader}>
                    <i className={`la la-microphone ${styles.stageIcon}`}></i>
                    <p className={styles.stageName}>AI Interview</p>
                  </div>
                  <div className={styles.substagesSection}>
                    <p className={styles.substagesLabel}>Substages</p>
                    <div className={styles.substagesList}>
                      <p className={styles.substageItem}>Waiting Interview</p>
                      <p className={styles.substageItem}>For Review</p>
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.pipelineStage}>
                  <div className={styles.stageHeader}>
                    <i className={`la la-brain ${styles.stageIcon}`}></i>
                    <p className={styles.stageName}>Personality Test</p>
                  </div>
                  <div className={styles.substagesSection}>
                    <p className={styles.substagesLabel}>Substages</p>
                    <div className={styles.substagesList}>
                ...
                <div className={styles.pipelineStage}>
                  <div className={styles.stageHeader}>
                    <i className={`la la-code ${styles.stageIcon}`}></i>
                    <p className={styles.stageName}>Coding Test</p>
                  </div>
                  <div className={styles.substagesSection}>
                    <p className={styles.substagesLabel}>Substages</p>
                    <div className={styles.substagesList}>
