...
export default function (props) {
  ...
  useEffect(() => {
    // Parent can call: window.dispatchEvent(new Event("generateAllQuestions"))
    const handler = () => generateAllQuestions();
    window.addEventListener("generateAllQuestions", handler as any);
    return () => window.removeEventListener("generateAllQuestions", handler as any);
  }, []);
                  ...
                  {group.questions.map((question, index) => (
                    <div
                      ...
                      onDrop={(e) => {
                        ...
                        const draggedQuestionId =
                          e.currentTarget && e.dataTransfer.getData("questionId");
                        const fromCategoryId = Number(
                          e.dataTransfer.getData("fromCategoryId")
                        );
